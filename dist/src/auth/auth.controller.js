...
let AuthController = class AuthController {
    ...
    async refresh(dto) {
        const isValid = await this.authService.validateRefreshToken(dto.userId, dto.refreshToken);
        if (!isValid)
            throw new common_1.UnauthorizedException();
        const tokens = await this.authService.generateTokens(dto.userId, dto.refreshToken);
